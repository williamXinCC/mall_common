...
public class WilliamGoods {
    ...
    private BigDecimal sellValueTotal;
    ...
    private String detailBannerImgs;
    ...
    public BigDecimal getSellValueTotal() {
        return sellValueTotal;
    }

    public void setSellValueTotal(BigDecimal sellValueTotal) {
        this.sellValueTotal = sellValueTotal;
    }
    ...
    public void setServiceTags(String serviceTags) {
        this.serviceTags = serviceTags == null ? null : serviceTags.trim();
    }
    ...
    public Integer getTitleCategoryId() {
    ...
    public String getDetailBannerImgs() {
        return detailBannerImgs;
    }

    public void setDetailBannerImgs(String detailBannerImgs) {
        this.detailBannerImgs = detailBannerImgs == null ? null : detailBannerImgs.trim();
    }
