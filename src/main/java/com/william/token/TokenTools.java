...
public class TokenTools {
	...
	private static final TokenTools INSTANCE = new TokenTools();

	public static TokenTools getInstance() {
		return INSTANCE;
	}
	 ...
	 */
	public String createToken(String uid, String phoneNumber, String timestamp, String channel) {
